  ...
  return (
    <>
      <section className="relative isolate overflow-hidden bg-navy-deep pt-36 pb-24 text-white">
        <img src="/images/industries-network.jpg" alt="Global enterprise network coverage" width={1920} height={1080} className="absolute inset-0 h-full w-full object-cover opacity-55" />
          ...
          <div className="rounded-3xl bg-navy-deep p-12 text-white lg:p-16">
            <div className="grid items-center gap-8 lg:grid-cols-2">
              ...
              <div className="flex flex-wrap gap-4 lg:justify-end">
                <CTAButton href="/contact" variant="cta">Request Briefing</CTAButton>
        ...
        <div className="grid items-start gap-12 lg:grid-cols-12">
          ...
          >
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              <CTAButton href="/contact" variant="primary">Discuss your {ind.name} environment</CTAButton>
            </div>
          </motion.div>
        </div>
      </Container>
