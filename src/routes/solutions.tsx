...
export const Route = createFileRoute("/solutions")({
  head: () =>
    buildPageSeo({
      ...
      description:
        "Enterprise infrastructure, networking, cybersecurity, cloud, data centre, managed services and more — engineered by Karell Global.",
      ogTitle: "Karell Global Solutions",
      ogDescription: "End-to-end enterprise IT solutions, engineered for scale and resilience.",
        ...
        <Container>
          <div className="rounded-3xl bg-navy-deep p-12 text-white lg:p-16">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <CTAButton to="/contact" variant="cta">Book Architecture Call</CTAButton>
              <CTAButton to="/industries" variant="secondary">Browse by Industry</CTAButton>
            </div>
          </div>
        </Container>
      </section>
      ...
      <Container>
        <div className="grid items-start gap-12 lg:grid-cols-12">
          ...
          >
            ...
            <div className="mt-8">
              <CTAButton to="/contact" variant="primary">Talk to a specialist</CTAButton>
            </div>
          </motion.div>
