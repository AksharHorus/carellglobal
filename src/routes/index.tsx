...
export const Route = createFileRoute("/")({
  head: () =>
    buildPageSeo({
      ...
      description:
        "Enterprise infrastructure, cybersecurity, cloud and managed services — engineered by Karell Global for global organizations.",
      ogTitle: "Karell Global — Enterprise IT Partner",
      ogDescription: "Future-ready infrastructure, security & cloud for enterprise scale.",
      image: "/og/home.jpg",
    }),
  component: Home,
});
      ...
      <Container className="relative pt-32 pb-20 lg:pt-40 lg:pb-28">
        <div className="grid items-center gap-14 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            >
              <CTAButton to="/contact" variant="primary">Schedule a Consultation</CTAButton>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-navy-deep p-12 text-white shadow-glow lg:p-20">
          ...
          <div className="relative max-w-3xl">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <CTAButton to="/contact" variant="cta">Book a Consultation</CTAButton>
