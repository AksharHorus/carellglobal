...
import contactHero from "@/assets/contact-noc.jpg";
...
export const Route = createFileRoute("/contact")({
  head: () =>
    buildPageSeo({
      ...
      description:
        "Speak with a Karell Global solutions architect. Offices across APAC, EMEA and the Americas. 24×7 emergency support.",
      ogTitle: "Contact Karell Global",
      ogDescription: "Reach a Karell solutions architect — global offices, 24×7 emergency support.",
  ...
  return (
    <>
      <section className="relative isolate overflow-hidden bg-navy-deep pt-36 pb-24 text-white">
        <img src={contactHero} alt="Karell Global 24x7 Network Operations Center" width={1920} height={1080} className="absolute inset-0 h-full w-full object-cover opacity-50" />
