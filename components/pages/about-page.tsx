  ...
  return (
    <>
      <section className="relative isolate overflow-hidden bg-navy-deep pt-36 pb-24 text-white">
        <img src="/images/about-team.jpg" alt="Karell Global leadership and engineering team" width={1920} height={1080} className="absolute inset-0 h-full w-full object-cover opacity-45" />
          ...
          <div className="rounded-3xl bg-navy-deep p-12 text-white lg:p-16">
            <div className="grid items-center gap-8 lg:grid-cols-2">
              ...
              <div className="flex flex-wrap gap-4 lg:justify-end">
                <CTAButton href="/contact" variant="cta">Contact Karell</CTAButton>
                <CTAButton href="/solutions" variant="secondary">Our Solutions</CTAButton>
              </div>
            </div>
          </div>
        </Container>
